...
if (isempty(validfieldlist))
    validfieldlist = {'ihead', 'shead', 'itail', 'stail', 'imid', 'smid', 'ihtValid', 'ibodytheta', 'sbodytheta', ...
                    ...
                    'ispine','spineLength','spineWidth','periAmp', 'periFreq', 'periPhase', 'periMean', 'spineDist',...
                    'spineCurv', 'spineTheta', 'sspineTheta', 'dspineCurv', 'dspineTheta','dbodytheta', 'dsbodytheta'};
