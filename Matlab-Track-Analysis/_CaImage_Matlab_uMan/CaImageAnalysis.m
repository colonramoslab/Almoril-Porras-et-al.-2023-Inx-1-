...
% path should be added before running...
addpath(genpath('C:\Users\jshha\Dropbox\ColonRamosLab\Matlab\CaImaging_uMan\_CaImage_Matlab_uMan'));
...
imFile=[];
imDir=[];
bgROI=[]; % make a prompt as to whether first ROI is background. 
...
saveName=strsplit(imFile,'.');
saveName=strcat(imDir,saveName{1}); 
