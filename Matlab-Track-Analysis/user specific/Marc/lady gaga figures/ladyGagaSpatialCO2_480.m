...
startFigNum = 2;
toExamine = 1;
spatialNavigationMaggotFigures(co2_spatial_ad(toExamine), co2_spatial_sno, po(toExamine), 'whichGraphs', 'HeadSwingAcceptanceDirection','startFigNum', startFigNum, 'backgroundColor', bc, 'SaveDirectory', SaveDirectory);
...
startFigNum = 3;
whichGraphs = {'DirectionHistogram', 'ReorientationRateVsHeading',  'InstantaneousDeltaThetaVsTheta', 'SpeedVsDirection',  'ReoDirVsHeading','ReoMagVsHeading', 'ReoDirDistribution'};
