...
% temperature
% 
basedir = 'J:\BEHAVIOR\04292010\Analysis\';
...
% for a location.
% 
%basedir = '\\labnas1\share\Mason\analyzed data\larval temperature ramps\';
%basedir = '\\labnas1\share\Mason\analyzed data\larvalramps03122010\';
%basedir = '\\labnas1\share\Mason\analyzed data\larvalramps03122010\L1';
%basedir = '\\labnas1\share\Mason\analyzed data\larvalramps03122010\L2';
%basedir = '\\labnas1\share\Mason\analyzed data\larvalramps03122010\L3';
%basedir = 'c:\temporary data\20100302\';
%basedir = 'c:\documents and settings\mason\desktop\test\';
%   
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% PART I %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if (~isfield(expt(1).track(1).dq, 'temp'))
   ...
   for j = 1:length(eset.expt)
       ...
       % Old way we did this.  Not sure what the real difference is though.
       %eset.expt(j).executeTrackFunction('addGlobalQuantity', 'temp', t, tm);
       %eset.expt(j).executeTrackFunction('addGlobalQuantity', 'dtemp', t, dtm);
   end
