...
validfieldlist = {'eti', 'iloc','sloc','vel', 'speed', 'nspeed', 'nvel', 'vnorm', 'speed_diff_local', 'theta','deltatheta', 'ddtheta', 'acc', 'curv',...
                    'pathLength','displacement','icov', 'covRatio', 'covTheta','scov', 'scovRatio', 'scovTheta', 'covMajor', ...
                    'covMinor', 'scovMajor', 'scovMinor','iarea', 'sarea', 'totalTime', 'lrdtheta', 'dcovRatio','xloc','yloc', 'etiFromTrackStart'};
