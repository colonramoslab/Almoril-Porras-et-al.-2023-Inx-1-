...
%      GETNAME by itself, creates a new GETNAME or raises the
%      existing singleton*.
%
...
% Last Modified by GUIDE v2.5 13-May-2010 15:29:38
...
if(nargin > 3)
    for index = 1:2:(nargin-3),
        ...
        switch lower(varargin{index})
         ...
         case 'default'
          set(handles.textfield, 'String', varargin{index+1});
        end
    end
end
...
% --- Executes on button press in yestbutton.
function yestbutton_Callback(hObject, eventdata, handles)
% hObject    handle to yestbutton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

handles.output = get(handles.textfield,'String');
...
% hObject    handle to textfield (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of textfield as text
%        str2double(get(hObject,'String')) returns contents of textfield as a double


% --- Executes during object creation, after setting all properties.
function textfield_CreateFcn(hObject, eventdata, handles)
% hObject    handle to textfield (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
